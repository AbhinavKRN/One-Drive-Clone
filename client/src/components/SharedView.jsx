...
const SharedView = ({
  ...
  const typeFilteredFiles = tabFilteredFiles.filter((file) => {
    ...
    if (fileTypeFilter === "word")
      return file.type.includes("word") || file.type.includes("doc");
    if (fileTypeFilter === "excel")
      return file.type.includes("excel") || file.type.includes("sheet");
    if (fileTypeFilter === "powerpoint")
      return (
  ...
  const filteredFiles = typeFilteredFiles.filter(
    (file) =>
  ...
  if (activeTab === "byYou") {
    return (
      <div
        className={`shared-view ${isDragOver ? "drag-over" : ""}`}
      ...
      >
        ...
        <div className="shared-empty-state">
          ...
          <img
            src="/images/empty2.webp"
            alt="Files you share will show up here"
          />
        </div>
      </div>
    );
      ...
      >
        <div className="shared-header">
          <div className="shared-tabs">
            ...
            <button
              className={`filter-btn ${
                fileTypeFilter === "folder" ? "active" : ""
              }`}
              onClick={() => setFileTypeFilter("folder")}
            >
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
                <path
                  d="M2 4.5C2 3.67157 2.67157 3 3.5 3H7.87868C8.14401 3 8.39849 3.10536 8.58579 3.29289L10.2929 5H16.5C17.3284 5 18 5.67157 18 6.5V15.5C18 16.3284 17.3284 17 16.5 17H3.5C2.67157 17 2 16.3284 2 15.5V4.5Z"
                  fill="#FDB900"
                />
              </svg>
              Folder
            ...
            >
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
                ...
                />
                <path
                  d="M7 6L8.5 12L10 6L11.5 12L13 6"
                  stroke="white"
                  strokeWidth="1.2"
                  fill="none"
                />
            ...
            >
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
                ...
                />
                <path
                  d="M7 7L10 10M10 10L13 13M10 10L13 7M10 10L7 13"
                  stroke="white"
                  strokeWidth="1.2"
                />
              </svg>
            ...
            <button
              className={`filter-btn ${
                fileTypeFilter === "powerpoint" ? "active" : ""
              }`}
        ...
        <div className="shared-empty-state">
          {fileTypeFilter === "all" ? (
            <>
              ...
              <img
                src="/images/empty2.webp"
                alt="Shared files will show up here"
              />
            </>
          ) : (
            <>
