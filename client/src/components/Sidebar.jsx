  ...
  return (
    <>
      {openCloseArrow ? (
        // 🔹 Collapsed Sidebar
        <aside
          className={`sidebar-closed ${isMobileOpen ? "sidebar-open" : ""}`}
        >
                ...
                <div ref={dropdownRef} className="sidebar-create-dropdown">
                  ...
                  >
                    <div className="sidebar-dropdown-icon folder-icon">
                      <img
                        src="https://res-1.cdn.office.net/files/fabric-cdn-prod_20230815.002/assets/item-types/16/folder.svg"
                        alt="folder"
                      />
                    </div>
                    <span>Folder</span>
                  ...
                  <div
                    className="sidebar-dropdown-item"
                    onClick={() => {
                      if (onWordDocument) onWordDocument();
                      setShowCreateDropdown(false);
                    }}
                  >
                  ...
                  <div
                    className="sidebar-dropdown-item"
                    onClick={() => {
                      if (onExcelWorkbook) onExcelWorkbook();
                      setShowCreateDropdown(false);
                    }}
                  >
                  ...
                  <div
                    className="sidebar-dropdown-item"
                    onClick={() => {
                      if (onPowerPointPresentation) onPowerPointPresentation();
                      setShowCreateDropdown(false);
                    }}
                  >
                  ...
                  <div
                    className="sidebar-dropdown-item"
                    onClick={() => {
                      if (onOneNoteNotebook) onOneNoteNotebook();
                      setShowCreateDropdown(false);
                    }}
                  >
                    <div className="sidebar-dropdown-icon onenote-icon">
                      <img
                        src="https://res-1.cdn.office.net/files/fabric-cdn-prod_20230815.002/assets/item-types/16/onetoc.svg"
                        alt="onetoc"
                      />
                    </div>
                  ...
                  <div
                    className="sidebar-dropdown-item"
                    onClick={() => {
                      if (onExcelSurvey) onExcelSurvey();
                      setShowCreateDropdown(false);
                    }}
                  >
                    <div className="sidebar-dropdown-icon excel-icon">
                  ...
                  <div
                    className="sidebar-dropdown-item"
                    onClick={() => {
                      if (onTextDocument) onTextDocument();
                      setShowCreateDropdown(false);
                    }}
                  >
                    <div className="sidebar-dropdown-icon text-icon">
                      <img
                        src="https://res-1.cdn.office.net/files/fabric-cdn-prod_20230815.002/assets/item-types/16/txt.svg"
                        alt="txt"
                      />
                    </div>
          ...
          <div className="sidebar-section">
            <div className="sidebar-user-heading">
              <ArrowRightRegular
                ...
                onClick={() => setOpenCloseArrow(!openCloseArrow)}
              />
            </div>
          ...
          <div className="sidebar-section">
            <div
              className="sidebar-heading-container"
              onClick={() => setIsBrowseFilesExpanded(!isBrowseFilesExpanded)}
            >
              <h3 className="sidebar-heading browse-heading">
                BROWSE FILES BY
              </h3>
          ...
          <div className="sidebar-section storage-section">
            ...
            <div className="storage-info">
              <p className="storage-text">
                <span className="storage-link">{formatBytes(storageUsed)}</span>{" "}
                used of {formatBytes(storageTotal)} (
              ...
              <div className="storage-bar">
                <div
                  ...
                  style={{
                    width: `${Math.max(2, Math.min(storagePercentage, 100))}%`,
                  }}
                ></div>
              </div>
            </div>
        ...
        <aside className={`sidebar ${isMobileOpen ? "sidebar-open" : ""}`}>
          ...
          <div className="sidebar-section">
            ...
            <ul className="sidebar-menu">
              ...
              <li
                className={filterType === "myfiles" ? "active" : ""}
                onClick={() => {
                  ...
                  folders
                    ...
                    .map((folder) => (
                      <li
                        key={folder.id}
                        className={
                          filterType === folder.name.toLowerCase()
                            ? "active"
                            : ""
                        }
                        onClick={() => {
          ...
          <div className="sidebar-section storage-section">
            <div className="sidebar-promo">
              <div className="storage-promo">
                <p className="storage-promo-text">
