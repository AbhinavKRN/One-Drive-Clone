  ...
  return (
    <div className="auth-container signup-page">
      <div className="auth-box signup-box">
        ...
        {step === 1 ? (
          <>
            ...
            <p className="auth-subtitle signup-subtitle">Enter your email address.</p>
          ...
          <>
            ...
            <p className="auth-subtitle">Make sure it's 6 characters or more.</p>
      ...
      <div className="auth-footer-links signup-footer-links">
        <a href="https://www.microsoft.com/en-in/servicesagreement" target="_blank" rel="noopener noreferrer">
          Terms of use
        </a>
